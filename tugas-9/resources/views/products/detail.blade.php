...
<body>
    ...
    <div class="container d-flex justify-content-center flex-column border border-dark rounded-3 col-md-8 mt-4 mb-4 p-3">
        ...
        <div class="d-flex justify-content-between align-items-center mt-4 mb-4">
            ...
            <div class="w-50 ms-3">
                ...
                <div class="d-flex justify-content-center">
                    <a href="{{ route('product.transaksi', ['id' => $product->id]) }}" class="btn btn-dark text-white mt-4" style="width: 100px;">Checkout</a>
                </div>
            </div>
        </div>
    </div>

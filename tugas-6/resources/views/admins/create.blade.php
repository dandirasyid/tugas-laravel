                    ...
                    <div class="card-body">
                        <form action="{{route('admin.store', $user->id)}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control" id="gambar" name="gambar" aria-describedby="gambar" placeholder="Masukan gambar produk">
                            </div>
                            <div class="form-group">
                                <label for="nama" class="fw-bold mt-2 mb-2">Nama Produk</label>
                                <input type="text" class="form-control" id="nama" name="nama" aria-describedby="nama" placeholder="Masukan nama produk">
                            </div>
                            <div class="form-group">
                                <label for="berat" class="fw-bold mt-2 mb-2">Berat</label>
                                <input type="number" name="berat" class="form-control" id="berat" placeholder="Masukan berat produk">
                            </div>
                            <div class="form-group">
                                <label for="harga" class="fw-bold mt-2 mb-2">Harga</label>
                                <input type="number" name="harga" class="form-control" id="harga" placeholder="Masukan harga produk">
                            </div>
                            <div class="form-group">
                                <label for="stok" class="fw-bold mt-2 mb-2">Stok</label>
                                <input type="number" name="stok" class="form-control" id="stok" placeholder="Masukan stok produk">
                            </div>
                            <div class="form-group">

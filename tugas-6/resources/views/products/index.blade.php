...
<body>
    <div class="container mt-4 mb-4 bg-info  d-flex flex-column align-items-center rounded-3">
        <div class="d-flex justify-content-between w-100 align-items-center">
            <div class="mt-5">
                <a href="/admin/1/list-products" class="btn btn-primary text-white">Halaman Pengguna Admin</a>
            </div>
            ...
            <div class="mt-5">
                <a href="/admin/2/list-products" class="btn btn-success text-white">Halaman Pengguna Merchant</a>
            </div>
        </div>
